...
const handleClick = () =>{
    window.location.href ="https://buy.stripe.com/test_fZe4j07UucVccQ83cc";
        ...
        <div className="lg:py-6 md:py-4 py-3 bg-gray-200">
            ...
            <div className="w-full mx-auto">
                <form onSubmit={handleBooking} className=" sm:w-10/12 w-11/12 mx-auto md:p-8 sm:p-6 p-4 md:py-14 sm:py-10 md:space-y-8 sm:space-y-6 space-y-5 mt-5 bg-white rounded">
                    ...
                    <div>
                    <button className="px-5 py-3 rounded-lg text-lg font-medium bg-green-400 text-white" onClick={handleClick}>Book an Appointment</button>
                    </div>
                </form>
            </div>
            <br />
